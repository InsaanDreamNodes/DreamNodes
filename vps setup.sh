...
sudo hostnamectl set-chassis "DreamNodes VPS"
sudo hostnamectl set-deployment "DreamNodes Cloud"
sudo hostnamectl set-location "DreamNodes Data Center"

# Fake product/system files
sudo tee /sys/devices/virtual/dmi/id/product_name 2>/dev/null <<< "DreamNodes Secure VPS"
sudo tee /sys/devices/virtual/dmi/id/product_version 2>/dev/null <<< "DN-2024-PRO"
sudo tee /sys/devices/virtual/dmi/id/sys_vendor 2>/dev/null <<< "DreamNodes Technologies"
sudo tee /sys/devices/virtual/dmi/id/chassis_vendor 2>/dev/null <<< "DreamNodes Cloud Infrastructure"
...
sudo tee /sys/devices/pci0000:00/0000:00:03.0/vendor 2>/dev/null <<< "DreamNodes"
sudo tee /sys/devices/pci0000:00/0000:00:03.0/device 2>/dev/null <<< "Virtual GPU"
sudo tee /sys/devices/pci0000:00/0000:00:03.0/subsystem_vendor 2>/dev/null <<< "DreamNodes"
sudo tee /sys/devices/pci0000:00/0000:00:03.0/subsystem_device 2>/dev/null <<< "Graphics Adapter"
